...
<body>
<nav class="navbar navbar-dark fixed-top flex-md-nowrap p-0 shadow-lg" style="background-color: rgba(27,51,73,0.59);">
    <a class="navbar-brand col-sm-3 col-md-2 mr-0 text-center text-white-50" style="padding-left: 5px; font-weight: 700; font-size: 22px;" href="{{route('dashboard')}}">
...
@auth
    <div class="container">
        ...
        <div class="container sticky-top pt-xl-5 overflow-auto"  style=" width: 99%; font-size: 12px; margin-left: 10%;">
            <div class="flex-sm-nowrap pt-3 mb-2 border-bottom shadow-sm">
                <h6 class="text-secondary font-weight-bolder ml-2"> &nbsp; @yield('form.title')</h6>
            </div>
            @yield('auth.content')
        </div>
...
<div class="d-flex justify-content-between align-items-center fixed-bottom p-1 shadow" style="background-color: rgba(27,51,73,0.59);">
    <div class="row w-100">
        <div class="col">
        </div>
