        ...
        <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-1 d-none d-md-block" style="width: 220px;">
                    ...
                    <input id="unidade" name="unidade" style="width: 135px; text-align: center; font-size: 12px;  color: #0f6674; border: none; font-weight: 600;" value="{{ \App\Models\Unidade::where('id',$campos->unidade_id)->first()->descricao }}" class="form-control form-control-light p-1" type="text" disabled>
                </div>
            </div>
