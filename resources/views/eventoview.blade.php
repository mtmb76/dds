        ...
        <div class="col col-sm-5 sm-1 py-0">
            ...
            <form class=" pl-sm-1" style="font-size: 12px; border: transparent;" action="{{route('eventoparticipante.add')}}" name="frmConsultaCracha" method="POST">
                ...
                <div class="input-group mt-4">
                    ...
                    <input id="cracha" name="cracha" class="btn btn-light border-0" style="font-size: 12px;" type="text" placeholder="Realize a leitura do crachá" aria-label="Realize a leitura do crachá" autofocus>
