...
<div class="cntr">
    ...
    <div class="box border-opacity-10 border-info" style="background-color: rgba(255,255,255,0.49);">

        <h4 class="font-weight-light text-black-50" >Credenciais</h4>
        ...
        <form action="{{route('autenticar')}}" method="POST" name="loginFrm">
          ...
          <div class="form-outline mb-2">
            <label class="form-label font-weight-light text-black-50" style="font-weight: bold; font-size: 12px;" for="email">E-mail</label>
          ...
          <!-- Password input -->
          <div class="form-outline mb-2">
            <label class="form-label font-weight-light text-black-50" style="font-weight: bold; font-size: 12px;" for="paswword">Senha</label>
          ...
          <!-- Terminal input -->
          <div class="form-outline mb-2">
            <label class="form-label font-weight-light text-black-50" style="font-weight: bold; font-size: 12px;" for="unidade">Unidade</label>
